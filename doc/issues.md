...
A __Milestone__ is a collection of issues that go along with a project, feature, or time period. Use these to keep yourself focused.

_Notifications, mentions, and References_ are avilible in the comments section via the [GitHub Flavored Markdown](https://docs.github.com/en/free-pro-team@latest/github/writing-on-github#name-and-team-mentions-autocomplete), this topic is to be covered in the [Mastering Markdown](http://guides.github.com/features/mastering-markdown/) portion later as well.
